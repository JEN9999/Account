...
//        assertEquals("1000001",accountDto.getAccountNumber());
    ...
    void successGetAccountsByUserId(){
        ...
        assertEquals("11111111", accountDtos.get(0).getAccountNumber());
        assertEquals(1000, accountDtos.get(0).getBalance());
        assertEquals("22222222", accountDtos.get(1).getAccountNumber());
        assertEquals(2000, accountDtos.get(1).getBalance());
        assertEquals("33333333", accountDtos.get(2).getAccountNumber());
